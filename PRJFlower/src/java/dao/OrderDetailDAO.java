...
public class OrderDetailDAO {
        ...
        try ( Connection connection = SQLServerConnection.getConnection();  PreparedStatement ps = connection.prepareStatement(sql);) {
            ...
            while (rs.next()) {
                OrderDetail obj = OrderDetail.builder()
                        ...
                        .orderDetailColorValue(rs.getString("orderDetailColorValue"))
    ...
    public boolean add(Cart obj, int orderId) {
        int check = 0;
        String sql = "INSERT INTO OrderDetail(orderId, productId, orderDetailProductImg, orderDetailProductName, orderDetailPriceProduct, orderDetailColorValue, orderDetailQuantity)"
                + " VALUES(?, ?, ?, ?, ? ,? ,?)";
        try ( Connection con = SQLServerConnection.getConnection();  PreparedStatement ps = con.prepareStatement(sql);) {
            ...
            ps.setObject(6, obj.getOrderDetailColorValue());
