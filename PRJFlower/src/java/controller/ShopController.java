...
public class ShopController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(categoryId != 0) {
            ...
            size = productDAO.getSize(colorIds, priceFrom, priceTo, true);
            lstProduct = productDAO.getAllPerPage(pageCur, numberProductPerPage, colorIds, priceFrom, priceTo, true);
            href = "shop?";
        ...
        List<Color> lstColor = colorDAO.getAll();
        
        request.setAttribute("href", href);
        request.setAttribute("priceFrom", priceFrom == null ? "10000" : priceFrom);
        request.setAttribute("priceTo", priceTo ==null ? "1000000" : priceTo);
        request.setAttribute("colorIds", colorIds);
