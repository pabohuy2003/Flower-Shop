            ...
            <div class="row px-xl-5">
                ...
                <div class="col-lg-3 col-md-4">
                    <form method="get" action="shop">
                        ...
                        <div class="bg-light p-4 mb-30">
                            <c:forEach items="${requestScope.lstColor}" var="s">
                                <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                                    <input <c:if test="${requestScope.Common.contains(requestScope.colorIds, s.colorId)}">checked=""</c:if> name="colorId" value="${s.colorId}" type="checkbox" class="custom-control-input" id="size${s.colorId}">
                                    <label class="custom-control-label" for="size${s.colorId}">${s.colorValue}</label>
                                </div>
                            </c:forEach>
                        </div>
                        <!-- Color End -->
